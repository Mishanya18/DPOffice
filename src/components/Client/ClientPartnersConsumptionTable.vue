<template>
  <el-row>
    <el-table :data="reportData" style="width: 100%">
      <el-table-column prop="partner" label="Партнер" min-width="150" />
        ...
        .then((data) => {
          for (let i = 0; i < data.total; i++) {
            let clientConsumpt = {
              ...
              partner: GetContent(data.result[i].PROPERTY_287),
            ...
            clientConsumpt.ram =
              Math.round((clientConsumpt.ram / 1024) * 1000) / 1000;
            clientConsumpt.ssd =
              Math.round((clientConsumpt.ssd / 1024) * 1000) / 1000;
            clientConsumpt.sas =
              Math.round((clientConsumpt.sas / 1024) * 1000) / 1000;
            clientConsumpt.sata =
              Math.round((clientConsumpt.sata / 1024) * 1000) / 1000;
